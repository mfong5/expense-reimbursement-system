function manageAllReimbursements() {
      ...
      xhttp.open("POST", "/ManageAllReimbursements", true);
      xhttp.send();
}
...
function Approve(id){
    ...
    form.setAttribute("action","/Managers/ManageReimbursements/AllReimbursements");
